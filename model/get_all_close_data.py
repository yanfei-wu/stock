...
Author: Yanfei Wu
Get the close price data for stocks in QQQ holdings in the past 6 years
"""
...
if __name__ == '__main__':
	...
	""" get the stock data from the past 6 year """
	end_date = datetime.now()
	start_date = datetime(end_date.year - 6, end_date.month, end_date.day)
	...
	# write to file
	data.to_csv('./data/all_close_data.csv')
